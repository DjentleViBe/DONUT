...
\begin{table}
  \caption{Maximum elongation across different geometry types after optimization using various algorithms.}
  \label{scipyoptim}
  \centering
  \begin{tabular}{l|ll|ll|ll}
    ...
    \cmidrule(r){1-7}
    & \multicolumn{2}{c|}{$\epsilon_\text{init}$ = 4.8509}& \multicolumn{2}{c|}{$\epsilon_\text{init}$ = 1.4985}&\multicolumn{2}{c}{$\epsilon_\text{init}$ = }             \\
    \cmidrule(r){1-7}
    Optimiser     & \texttt{nfev}     & $\epsilon_\text{max}$ & \texttt{nfev}     & $\epsilon_\text{max}$ & \texttt{nfev}     & $\epsilon_\text{max}$ \\
    \midrule
    L-BFGS-B & 372  & $3.0968$  & 672 & 1.3620 \\
    Nelder-Mead     & 95 & $4.3647$   & 88 & 1.3766 \\
    Trust-constr     &   186     & $4.7543$  & 64 & 1.4617\\
    COBYLA     & 184       & $2.7906$  & 62 & 1.1257\\
    COBYQA     & 188       & $3.7076$  & 66 & 1.2460\\
    SLSQP     & 283       & $3.5246$  & 101 & 1.1341\\
    Powell     &    184    & $4.0724$  & 62 & 1.4957 \\
    \bottomrule
  \end{tabular}
\end{table}
