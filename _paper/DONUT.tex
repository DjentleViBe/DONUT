...
\begin{table}
  \caption{Maximum elongation for Type 1 geometry after optimiser with various algorithms.}
  \label{scipyoptim}
  \centering
  \begin{tabular}{lll}
    \toprule
    \multicolumn{3}{c}{$\epsilon_\text{init}$ = 2.8075}                   \\
    \cmidrule(r){1-3}
    Optimiser     & \texttt{nfev}     & $\epsilon_\text{max}$ \\
    \midrule
